...
public class ReportBuilder {
	...
	void writeTestCaseResult(AutomationTestCaseStep step) throws IOException {
		...
		output.write("<tr>");
		output.write("<td width=100 bgcolor=#EFFBF5  align=middle><font face=arial size=2 color=black>"
				+ step.getAction() + "</font></td>");
		output.write("<td width=100 bgcolor=#EFFBF5  align=middle><font face=arial size=2 color=black>"
				+ step.getReportingName() + "</font></td>");
		output.write("<td width=150 bgcolor=#EFFBF5  align=middle><font face=arial size=2 color=black>"
				+ step.getIdentifierType() + "-" + step.getIdentifier() + "</font></td>");
		if (step.getStatus() != null) {
			if (step.getStatus().getStatus().equals(ValidTestStatus.FAIL)) {
				output.write("<td width=100 bgcolor=#EFFBF5  align=middle><font face=arial size=2 color=RED><b>"
						+ step.getStatus().getStatus() + "</b></font></td>");
			} else {
				output.write("<td width=100 bgcolor=#EFFBF5  align=middle><font face=arial size=2 color=green><b>"
						+ step.getStatus().getStatus() + "</b></font></td>");
			}
			output.write("<td width=100 bgcolor=#EFFBF5  align=middle><font face=arial size=2><b>"
					+ step.getStatus().getStatusDesc() + "</b></font></td>");
		} else {
			output.write("<td width=100 bgcolor=#EFFBF5  align=middle><font face=arial size=2 color=black ><b>"
