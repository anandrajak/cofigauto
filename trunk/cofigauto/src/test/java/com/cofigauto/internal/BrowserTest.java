...
/**
 * The class <code>BrowserTest</code> contains tests for the class <code>{@link Browser}</code>.
 *
...
public class BrowserTest {
	...
	public void testGetDriverByName_1()
		throws Exception {
		String name = "";
	 ...
	 */
	@Test(expected = com.cofigauto.exception.ConfigurationException.class)
	public void testGetDriverByName_2()
		throws Exception {
		String name = "";
		Capabilities desiredCapabilities = new DesiredCapabilities();

		RemoteWebDriver result = Browser.getDriverByName(name, desiredCapabilities);
	 ...
	 */
	@Test(expected = com.cofigauto.exception.ConfigurationException.class)
	public void testGetDriverByName_3()
		throws Exception {
		String name = "";
	 ...
	 */
	@Test(expected = com.cofigauto.exception.ConfigurationException.class)
	public void testGetDriverByName_4()
		throws Exception {
		String name = "";
		Capabilities desiredCapabilities = new DesiredCapabilities();
