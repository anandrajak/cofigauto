...
/**
 * The class <code>TestStatusTest</code> contains tests for the class <code>{@link TestStatus}</code>.
 *
...
public class TestStatusTest {
	 ...
	 */
	@Test
	public void testGetStatusDesc_1()
		throws Exception {
		TestStatus fixture = new TestStatus();
		fixture.setStatus(ValidTestStatus.FAIL);
		fixture.setStatusDesc("");
	 ...
	 */
	@Test
	public void testSetStatusDesc_1()
		throws Exception {
		TestStatus fixture = new TestStatus();
		fixture.setStatus(ValidTestStatus.FAIL);
		fixture.setStatusDesc("");
